...
# Use the GPU when available (device=0); fall back to CPU (device=-1).
# On a Tesla T4 you can comfortably use "openai/whisper-base" or even
# "openai/whisper-small" for better transcription accuracy.
...
class WhisperASRModel(IASRModel):
    def __init__(self, model_name="openai/whisper-base"):
        self.asr = pipeline("automatic-speech-recognition", model=model_name,
                            return_timestamps="word", device=_DEVICE)
        self._transcript = ""
